...
export const Deplacement = {
    ...
    hexa:[
        ...
        {x:1,y:2,contenu:{case:new Forest(),defense:null,unité:null,action:null,highlight:null,select:null}},
        {x:1,y:3,contenu:{case:null,defense:null,unité:new SoldatAxis(),action:null,highlight:null,select:null}},
        ...
        {x:2,y:8,contenu:{case:new Hills(),defense:null,unité:new SoldatAxis(),action:null,highlight:null,select:null}},
        ...
        {x:6,y:4,contenu:{case:null,defense:null,unité:new SoldatAxis(),action:null,highlight:null,select:null}},
        {x:6,y:5,contenu:{case:null,defense:new Wire(),unité:null,action:null,highlight:null,select:null}},
        ...
        {x:6,y:10,contenu:{case:null,defense:null,unité:new CharAxis(),action:null,highlight:null,select:null}},
        {x:6,y:11,contenu:{case:null,defense:new Wire(),unité:null,action:null,highlight:null,select:null}},
