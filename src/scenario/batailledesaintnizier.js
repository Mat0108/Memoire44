...
export const Batailledesaintnizier = {
    ...
    hexa:[
        ...
        {x:0,y:1,contenu:{case:null,defense:null,unité:new SoldatAxis(),action:null,highlight:null}},
        {x:0,y:2,contenu:{case:new Forest(),defense:null,unité:new SoldatAxis(),action:null,highlight:null}},
        {x:0,y:3,contenu:{case:null,defense:null,unité:null,action:null,highlight:null}},
        {x:0,y:4,contenu:{case:null,defense:null,unité:null,action:new SoldatAxis(),highlight:null}},
        {x:0,y:5,contenu:{case:new Forest(),defense:null,unité:new SoldatAxis(),action:null,highlight:null}},
        {x:0,y:6,contenu:{case:null,defense:null,unité:null,action:new SoldatAxis(),highlight:null}},
        {x:0,y:7,contenu:{case:new Forest(),defense:null,unité:null,action:new SoldatAxis(),highlight:null}},
        {x:0,y:8,contenu:{case:null,defense:null,unité:null,action:null,highlight:null}},
        {x:0,y:9,contenu:{case:new RoadRight(2),defense:null,unité:new SoldatAxis(),action:null,highlight:null}},
        {x:0,y:10,contenu:{case:null,defense:null,unité:null,action:new SoldatAxis(),highlight:null}},
        {x:0,y:11,contenu:{case:new Forest(),defense:null,unité:null,action:new SoldatAxis(),highlight:null}},
        ...
        {x:1,y:1,contenu:{case:new Forest(),defense:null,unité:null,action:null,highlight:null}},
        ...
        {x:1,y:8,contenu:{case:new RoadRight(2),defense:null,unité:null,action:null,highlight:null}},
        ...
        {x:2,y:6,contenu:{case:new RoadCurve(6),defense:null,unité:null,action:null,highlight:null}},
        {x:2,y:7,contenu:{case:new RoadRight(1),defense:null,unité:null,action:null,highlight:null}},
        {x:2,y:8,contenu:{case:new RoadCurve(3),defense:null,unité:null,action:null,highlight:null}},
        ...
        {x:3,y:1,contenu:{case:new Hills(),defense:null,unité:null,action:null,highlight:null}},
        {x:3,y:2,contenu:{case:new Hills(),defense:new SandBag(),unité:new SoldatAllies(3),action:null,highlight:null}},
        {x:3,y:3,contenu:{case:new Hills(),defense:null,unité:null,action:null,highlight:null}},
        {x:3,y:4,contenu:{case:new Hills(),defense:new SandBag(),unité:new SoldatAllies(3),action:null,highlight:null}},
        {x:3,y:5,contenu:{case:new RoadHillCurve(1),defense:null,unité:null,action:null,highlight:null}},
        {x:3,y:6,contenu:{case:new Hills(),defense:new SandBag(),unité:new SoldatAllies(3),action:null,highlight:null}},
        {x:3,y:7,contenu:{case:new Hills(),defense:null,unité:null,action:null,highlight:null}},
        {x:3,y:8,contenu:{case:new Hills(),defense:new SandBag(),unité:new SoldatAllies(3),action:null,highlight:null}},
        {x:3,y:9,contenu:{case:new Hills(),defense:null,unité:null,action:null,highlight:null}},
        {x:3,y:10,contenu:{case:new Hills(),defense:new SandBag(),unité:new SoldatAllies(3),action:null,highlight:null}},
        {x:3,y:11,contenu:{case:new Hills(),defense:null,unité:null,action:null,highlight:null}},

        {x:4,y:0,contenu:{case:null,defense:null,unité:null,action:null,highlight:null}},
        {x:4,y:1,contenu:{case:new Hills(),defense:null,unité:null,action:null,highlight:null}},
        ...
        {x:4,y:6,contenu:{case:new RoadCurve(2),defense:null,unité:null,action:null,highlight:null}},
        {x:4,y:7,contenu:{case:new RoadRight(1),defense:null,unité:null,action:null,highlight:null}},
        {x:4,y:8,contenu:{case:new RoadCurve(5),defense:null,unité:null,action:null,highlight:null}},
        ...
        {x:5,y:0,contenu:{case:new Hills(),defense:null,unité:null,action:null,highlight:null}},
        {x:5,y:1,contenu:{case:new Village(),defense:null,unité:new SoldatAllies(3),action:null,highlight:null}},
        ...
        {x:5,y:6,contenu:{case:new Village(),defense:null,unité:new SoldatAllies(3),action:null,highlight:null}},
        {x:5,y:7,contenu:{case:null,defense:null,unité:null,action:null,highlight:null}},
        {x:5,y:8,contenu:{case:new RoadCurve(4),defense:null,unité:null,action:null,highlight:null}},
        {x:5,y:9,contenu:{case:new Forest(),defense:null,unité:null,action:null,highlight:null}},
        {x:5,y:10,contenu:{case:new Mountain(),defense:null,unité:null,action:null,highlight:null}},
        {x:5,y:11,contenu:{case:new Mountain(),defense:null,unité:null,action:null,highlight:null}},
        ...
        {x:6,y:8,contenu:{case:new RoadCurve(1),defense:null,unité:null,action:null,highlight:null}},
        {x:6,y:9,contenu:{case:null,defense:null,unité:null,action:null,highlight:null}},
        {x:6,y:10,contenu:{case:new Mountain(),defense:null,unité:null,action:null,highlight:null}},
        {x:6,y:11,contenu:{case:new Mountain(),defense:null,unité:null,action:null,highlight:null}},
        ...
        {x:7,y:6,contenu:{case:new Forest(),defense:null,unité:null,action:null,highlight:null}},
        {x:7,y:7,contenu:{case:null,defense:null,unité:null,action:null,highlight:null}},
        {x:7,y:8,contenu:{case:new RoadRight(3),defense:null,unité:null,action:null,highlight:null}},
        ...
        {x:8,y:2,contenu:{case:new Hills(),defense:null,unité:null,action:null,highlight:null}},
        ...
        {x:8,y:9,contenu:{case:new Village(),defense:null,unité:new SoldatAllies(3),action:null,highlight:null}},
