...
export class SoldatAxis extends SoldatGenerique {
    constructor(nb){  //orientation: true => bas, false => haut 
        ...
        super(`images/base/${orientation ? "u_gerinf_top":"u_gerinf_bottom"}.png`,nb ? nb : 4,nb ? nb : 4,[3,2,1],2,1,"w-[38%]")
    }
}
...
export class CharAxis extends SoldatGenerique {
    constructor(){
        let orientation = true;
        super(`images/base/${orientation ? "u_gertank_top":"u_gertank_bottom"}.png`,3,3,[3,3,3],2,1,"w-[40%]")
    }
}
