...
const About = ()=>{
    return <div className="w-full h-full p-[10%] flex flex-col gap-4 center text-[18px] text-white text-justify relative">
        ...
        <p className="text-[26px] pt-4">Objectif du projet
        </p>
        ...
        <p className="text-[26px] pt-4"> Respect des droits d'auteur
        </p>
        ...
        <p className="text-[26px] pt-4"> Utilisation personnelle
        </p>
        ...
        <p className="text-[26px] pt-4"> Avertissement
        </p>
